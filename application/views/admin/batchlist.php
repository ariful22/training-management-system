...
function addcourse()
{
    ...
    $('.modal-title').text('Batch Form'); // Set Title to Bootstrap modal title
}
...
function editcourse(id)
{
    ...
    $.ajax({
        url : "Batch/ajax_edit/"+id,
        type: "GET",
        dataType: "JSON",
        success: function(data)
        {

            $('[name="student_batch_id"]').val(data.student_batch_id);
...
function deletecourse(id)
{
    if(confirm('Are you sure to remove the Batch?'))
    {
                                            ...
                                            <div class="modal-dialog modal-dialog-centered" role="document">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title" id="activitiesLongTitle">Batch Form</h5>
     ...
     <input type="hidden" value="" name="id"/> <div class="form-group">
                          <div class="col-md-9">
                              <input name="student_batch_id" class="form-control" type="hidden">
                              <span class="help-block"></span>
                          </div>
                      </div>                                                 <div class="form-group row">
                                                                <label for="tc" class="col-sm-4 col-form-label">Batch ID</label>
                                                                <div class="col-sm-8">
                                                                    <input type="text" class="form-control" id="tc" name="batch_id" placeholder="Batch ID">
                                                                </div>
                                                            </div>
	 <div class="form-group row">
                                        <label for="cs" class="col-sm-4 col-form-label">Batch Name</label>
                                        <div class="col-sm-8">
                                            <input type="text" class="form-control" id="cs" name="batch_name" placeholder="Batch Name">
                                        </div>
                                    </div>
                                                        </form>
                                                    </div>
