...
function editcourse(id)
{
    ...
    $.ajax({
        url : "Courses/ajax_edit/"+id,
        type: "GET",
        dataType: "JSON",
        success: function(data)
        {

            $('[name="student_course_id"]').val(data.student_course_id);
...
function save()
{
    ...
    if(save_method == 'add') {
        url = "Courses/ajax_add";
    } else {
        url = "Courses/ajax_update";
    }
...
function deletecourse(id)
{
    if(confirm('Are you sure to remove the Course?'))
    {
                                            ...
                                            <div class="modal-dialog modal-dialog-centered" role="document">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title" id="activitiesLongTitle">Course Form</h5>
     ...
     <input type="hidden" value="" name="id"/> <div class="form-group">
                          <div class="col-md-9">
                              <input name="student_course_id" class="form-control" type="hidden">
                              <span class="help-block"></span>
                          </div>
                      </div>                                                 <div class="form-group row">
                                                                <label for="tc" class="col-sm-4 col-form-label">Course ID</label>
                                                                <div class="col-sm-8">
                                                                    <input type="text" class="form-control" id="tc" name="course_id" placeholder="Course ID">
                                                                </div>
                                                            </div>
	 <div class="form-group row">
                                        <label for="cs" class="col-sm-4 col-form-label">Course Name</label>
                                        <div class="col-sm-8">
                                            <input type="text" class="form-control" id="cs" name="course_name" placeholder="Course Name">
                                        </div>
                                    </div>
                                                        </form>
                                                    </div>
