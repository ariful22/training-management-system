<footer class="sticky-footer">
            <div class="container">
                <div class="text-center">
                    <small>Copyright © <a href="https://freelancerlabbd.com/" target="_blank">Freelancerlab</a> 2019</small>
                </div>
            </div>
        </footer>
...
<!-- Bootstrap core JavaScript-->
    ...
    <script src="<?php echo base_url('public/front/js/bootstrap-select.js');?>"></script>
